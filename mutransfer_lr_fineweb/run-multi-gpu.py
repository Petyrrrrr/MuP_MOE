...
class MultiGPURunner:
    ...
    def create_log_directory(self, base_path: str = "/home/ubuntu/MuP_MOE/std_out/mutransfer_lr_fineweb") -> str:
    ...
    def build_command(self, job: Job, job_desc: str) -> Tuple[List[str], str, Optional[str]]:
        ...
        config = job.config
        out_dir = (
            f"run_data/mutransfer_lr_fineweb/out_{self.timestamp}/"
    ...
    def run(self):
        ...
        print(f"\nResults directory: run_data/mutransfer_lr_fineweb/out_{self.timestamp}")
        print(f"Logs directory: {self.log_dir}")
